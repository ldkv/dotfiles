...
from .configs import Config, commit_updated_changes, is_windows

USER_HOME_PATH = Path.home()
DOTFILES_PATH = Config.get_dotfiles_path()
...
def update(is_simulator: bool = False) -> None:
    ...
    commit_updated_changes("Update to latest template version.")
